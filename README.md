...
### Импорт в NextDNS на телефоне

На Android отдельный экран не нужен: блок **Частный DNS через NextDNS** находится на главном экране под результатом.
...
3. Нажать **Копировать** и вставить адрес в «Настройки → Сеть и интернет → Частный DNS».

### Импорт в NextDNS (desktop)
